...
CREATE TABLE Customer(id SERIAL PRIMARY KEY, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL);
...
VALUES ((SELECT id FROM Customer WHERE first_name = 'John'), true),((SELECT id FROM Customer WHERE first_name = 'Jerome'), false);
...
CREATE TABLE Student (student_id SERIAL PRIMARY KEY, name VARCHAR(100) NOT NULL UNIQUE, age INTEGER CHECK (age <= 15);
